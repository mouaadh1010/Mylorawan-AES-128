...
NS_LOG_COMPONENT_DEFINE("CesarFrame");
int encryption = 4;
std::string msgs = "Essalamou alaikoum";
main(int argc, char* argv[])
{
    ...
    LogComponentEnable("CesarFrame", LOG_LEVEL_ALL);
    ...
    //oneShotHelper.SetDataToSend(msgs,encryption);

    oneShotHelper.SetSendTime(Seconds(4));   
    oneShotHelper.Install(endDevices.Get(0));
    //oneShotHelper.SetDataToSend("ATTACKATONCE",encryption);
    ...
    //networkServerHelper.SetDecrypt(encryption);
