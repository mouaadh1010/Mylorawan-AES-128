...
int main (int argc, char *argv[])
{
  ...
  ************************/
  ...
  //+++++++++++++++++++++++++++++++++++++++++++++++++
  periodicSenderHelper.SetPacketSize (23);
  //periodicSenderHelper.EnableAes(aesKey,"mymessage");
  //-------------------------------------------------
  ...
  if (aesKey !=0)
  {
    radioEnergyHelper.Set ("TxCurrentA", DoubleValue (0.09));
    radioEnergyHelper.SetTxCurrentModel ("ns3::ConstantLoraTxCurrentModel",
                                       "TxCurrent", DoubleValue (0.09));
  }
  */
  //---------------------------------------------------------
